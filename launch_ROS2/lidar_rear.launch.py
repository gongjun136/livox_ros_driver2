...
heartbeat_node_id = 12
heartbeat_topic = '/diagnostics/heartbeat/livox_rear'

cur_path = os.path.split(os.path.realpath(__file__))[0] + '/'
cur_config_path = cur_path + '../config'
user_config_path = os.path.join(cur_config_path, 'MID360s_config_rear.json')
